...
- **config:** watch user-defined path to Radicle CLI binary for changes (file deleted/replaced) too. Previously only the default paths per OS were being watched.
