...
- **patches**: show new view in the sidebar listing all Radicle Patches, including a tooltip with more info on hover ([#43](https://github.com/cytechmobile/radicle-vscode-extension/issues/43))
